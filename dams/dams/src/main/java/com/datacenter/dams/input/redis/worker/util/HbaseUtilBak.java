...
public class HbaseUtilBak {
    private static final Logger logger = LogManager.getLogger(HbaseUtilBak.class);
    ...
    public static void createTable(String tableName, String[] columnFamilys, Configuration conf) throws Exception {
        ...
        if (hAdmin.tableExists(tableName)) {
            logger.info("hbase表 " + tableName + "以创建成功");
        } else {
            // 新建一个 scores 表的描述
    ...
    public static void deleteTable(String tableName, Configuration conf) throws Exception {
        ...
        if (hAdmin.tableExists(tableName)) {
            ...
            logger.info("habse表" + tableName + "删除表成功");

        } else {
            logger.info("删除的habse表" + tableName + "不存在");
        }
    }
    ...
    public static void addRow(String tableName, String row, String columnFamily, String column, String value, Configuration conf) throws
            Exception {
    ...
    public static Result getRow(String tableName, String row, Configuration conf) throws Exception {
        ...
        return result;
        /*
         * // 输出结果 for (KeyValue rowKV : result.raw()) {
     ...
     *
     */
    public static ResultScanner getRowsByStartEndTime(String tableName, String startRow, String stopRow, Configuration conf) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    logger.error("hbase 操作IO异常", e);
                }
            } catch (Exception e) {
                logger.error("hbase master节点异常，zookeeper异常", e);
            ...
            try {
                ...
                logger.error("hbase HTable表关闭失败", e);
            }
        }
        return null;
    }
