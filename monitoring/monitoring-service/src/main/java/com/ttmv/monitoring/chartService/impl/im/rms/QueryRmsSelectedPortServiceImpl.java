...
public class QueryRmsSelectedPortServiceImpl extends QuerySelectedPort {

	private static Logger logger = LogManager.getLogger(QueryRmsSelectedPortServiceImpl.class);
