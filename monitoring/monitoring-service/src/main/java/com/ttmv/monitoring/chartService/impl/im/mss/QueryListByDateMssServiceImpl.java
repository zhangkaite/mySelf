 ...
 *
 */
public class QueryListByDateMssServiceImpl extends QueryListByDate {

	private static Logger logger = LogManager.getLogger(QueryListByDateMssServiceImpl.class);
	...
	protected List getQuery(Object obj) throws Exception {
		...
		List<MssServerData> result = iMssServerDataInter.queryListOnDateMssServerDataByIpAndServerTypeAndPort((DataBeanQuery) obj);
