...
public class QueryPHPSelectedPortServiceImpl extends QuerySelectedPort {

	private static Logger logger = LogManager.getLogger(QueryPHPSelectedPortServiceImpl.class);
