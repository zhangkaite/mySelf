 ...
 *
 */
public class QueryTasByIdServiceImpl  extends QueryDataById {

	private static Logger logger = LogManager.getLogger(QueryTasByIdServiceImpl.class);
	...
	protected List getQuery(Object obj) throws Exception {
		...
		list.add(iTasServerDataInter.queryTasServerData((BigInteger)obj));
		return list;
	}
