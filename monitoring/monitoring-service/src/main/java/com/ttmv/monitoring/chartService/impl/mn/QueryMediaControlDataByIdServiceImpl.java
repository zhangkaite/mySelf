 ...
 *
 */
public class QueryMediaControlDataByIdServiceImpl  extends QueryDataById {

	private static Logger logger = LogManager.getLogger(QueryMediaControlDataByIdServiceImpl.class);
	...
	protected List getQuery(Object obj) throws Exception {
		...
		list.add(iMediaControlDataInter.queryMediaControlData((BigInteger)obj));
		return list;
	}
