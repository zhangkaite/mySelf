...
public class QueryUmsSelectedPortServiceImpl extends QuerySelectedPort {

	private static Logger logger = LogManager.getLogger(QueryUmsSelectedPortServiceImpl.class);
