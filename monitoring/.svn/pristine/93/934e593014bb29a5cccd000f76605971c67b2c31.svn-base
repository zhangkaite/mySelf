...
public class QueryPrsSelectedPortServiceImpl extends QuerySelectedPort {

	private static Logger logger = LogManager.getLogger(QueryPrsSelectedPortServiceImpl.class);
