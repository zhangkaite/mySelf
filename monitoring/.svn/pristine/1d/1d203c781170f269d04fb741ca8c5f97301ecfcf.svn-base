 ...
 *
 */
public class QueryMtsByIdServiceImpl  extends QueryDataById {

	private static Logger logger = LogManager.getLogger(QueryMtsByIdServiceImpl.class);
	...
	protected List getQuery(Object obj) throws Exception {
		...
		list.add(iMtsServerDataInter.queryMtsServerData((BigInteger)obj));
		return list;
	}
