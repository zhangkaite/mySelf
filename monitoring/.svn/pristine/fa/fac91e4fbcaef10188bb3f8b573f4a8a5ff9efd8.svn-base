...
public class QueryHpSelectedPortServiceImpl extends QuerySelectedPort {

	private static Logger logger = LogManager.getLogger(QueryHpSelectedPortServiceImpl.class);
