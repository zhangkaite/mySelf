...
public class QueryMssSelectedPortServiceImpl extends QuerySelectedPort {

	private static Logger logger = LogManager.getLogger(QueryMssSelectedPortServiceImpl.class);
