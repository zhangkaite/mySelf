 ...
 *
 */
public class QueryListSSDServiceImpl extends QueryListDate {

	private static Logger logger = LogManager.getLogger(QueryListSSDServiceImpl.class);
	...
	protected List getQuery(Object obj) throws Exception {
		...
		return iScreenShotDataInter.queryListScreenShotDataByIpAndServerTypeAndPort((DataBeanQuery) obj);
	}
