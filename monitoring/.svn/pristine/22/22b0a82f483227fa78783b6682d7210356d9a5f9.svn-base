...
public class QueryVideoSelectedPortServiceImpl extends QuerySelectedPort {

	private static Logger logger = LogManager.getLogger(QueryVideoSelectedPortServiceImpl.class);
