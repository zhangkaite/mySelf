...
public class QueryTasSelectedPortServiceImpl extends QuerySelectedPort {

	private static Logger logger = LogManager.getLogger(QueryTasSelectedPortServiceImpl.class);
