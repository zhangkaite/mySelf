...
import com.ttmv.datacenter.paycenter.service.facade.template.FacadeService;
import com.ttmv.datacenter.paycenter.service.processor.invoke.BeanInvoke;
import com.ttmv.datacenter.utils.check.CheckParameterUtil;
import com.ttmv.datacenter.utils.message.DefaultTmcpMessage;

/**  
 * @author Damon_Zs   
 * @version 创建时间：2015年2月9日 上午11:05:33  
 * @explain :支付业务处理模板
 */
public abstract class FacadeService implements GromitService {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (gromitRequest.getMessage() != null) {
				DefaultTmcpMessage dtm = new DefaultTmcpMessage(0x2000,0x2999,2);
