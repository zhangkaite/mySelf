 ...
 */
@Service("banLiveRoomCallbackQ")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class BanLiveRoomCallbackQ {
	
	private static Logger logger = LogManager.getLogger(BanLiveRoomCallbackQ.class);
	@Autowired
	...
	public void excute(UserInfoBean userInfoBean){
		...
		logger.info("频道解播向IM、php队列推送成功，推送的内容:"+resJson);
