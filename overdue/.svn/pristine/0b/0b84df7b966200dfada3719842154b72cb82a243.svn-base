 ...
 */
@Service
public class InOverdueEndCMPWorkImpl extends AbstractWorker {
	private static Logger logger = LogManager.getLogger(InOverdueEndCMPWorkImpl.class);
