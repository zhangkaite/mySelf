...
public class StoreReqStatusBolt extends BaseRichBolt {

	private static Logger logger = Logger.getLogger(StoreReqStatusBolt.class);
	...
	public void execute(Tuple tuple) {
		try {
			...
			logger.info("StoreReqStatusBolt 完成一次业务花费的时间:" + period);
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		declarer.declare(new Fields(Constants.SEND_REQSTATUS_BOLT));
